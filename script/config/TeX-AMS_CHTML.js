...
(function(d, h, l, g, m, b, j) {
    ...
    var n = c.Event = {
        ...
        ContextMenu: function(t, E, w) {
            ...
            g.__Queue(G, D, ["ContextMenu", n, C, E, w]);
            return n.False(t)
        },
    ...
    g.__Queue(d.Register.StartupHook("End Config", {}), [e], ["getImages", f], ["Styles", l, o.styles], ["Post", d.Startup.signal, "MathEvents Ready"], ["loadComplete", l, "[MathJax]/extensions/MathEvents.js"])
}
    ...
    g.Augment({
        ...
        preTranslate: function(p) {
            ...
            for (t = 0; t < q; t++) {
                ...
                if (n.PHTML.display) {
                    o = e.Element("div", {
                        className: "MathJax_PHTML_Display"
                    });
                    o.appendChild(v)
                }
            ...
            toPreviewHTML: function(q) {
                ...
                if (n && p) {
                    var r = e.Element("span", {
                        ...
                        style: {
                            "margin-bottom": g.Em(-(n.PHTML.d - 0.05))
                        }
                    }]]]]], ["span", {}, [["span", {}, [["span", {
                        style: {
                            "margin-top": g.Em(-(n.PHTML.h - 0.05))
                        }
                    }]]]]]]);
    ...
    var d = MathJax.Extension["fast-preview"] = {
        ...
        Config: function() {
            if (b.config["CHTML-preview"]) {
                MathJax.Hub.Config({
                    "fast-preview": b.config["CHTML-preview"]
                })
            }
            var m, j, k, h, l;
            var i = this.config;
