...
(function (d, c, j) {
    ...
    var b = e.Item = MathJax.Object.__Subclass({
        type: "base",
    ...
    b.close = b.__Subclass({
        type: "close",
        isClose: true
    });
    b.prime = b.__Subclass({
        type: "prime",
        checkItem: function (m) {
    ...
    b.right = b.__Subclass({
        type: "right",
        isClose: true,
        delim: ")"
    });
    b.begin = b.__Subclass({
        type: "begin",
        isOpen: true,
        checkItem: function (m) {
            if (m.type === "end") {
    ...
    var a = MathJax.Object.__Subclass({
        __Init: function (n, o) {
            this.string = n;
            this.i = 0;
            this.macroCount = 0;
