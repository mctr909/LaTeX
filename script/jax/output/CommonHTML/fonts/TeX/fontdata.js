...
(function(a, c, r) {
    ...
    a.FONTDEF.TeX = {
        ...
        UNKNOWN: {
            R: {
                className: "MJXc-TeX-unknown-R"
            },
            I: {
                className: "MJXc-TeX-unknown-I"
            },
            B: {
                className: "MJXc-TeX-unknown-B"
            },
            BI: {
                className: "MJXc-TeX-unknown-BI"
            }
        },
        VARIANT: {
            normal: {
            ...
            "-TeX-vec": {
                fonts: ["MathJax_Vector"],
                cache: {}
            },
            "-TeX-vec-bold": {
                fonts: ["MathJax_Vector-Bold"],
                cache: {}
            },
            "-largeOp": {
                fonts: [g, h, m, i],
        ...
        DELIMITERS: {
            ...
            710: {
                dir: j,
                HW: [[0.267 + 0.25, m], [0.567 + 0.25, h], [1.005 + 0.33, g], [1.447 + 0.33, f], [1.909, d]]
            },
            732: {
                dir: j,
                HW: [[0.333 + 0.25, m], [0.555 + 0.25, h], [1 + 0.33, g], [1.443 + 0.33, f], [1.887, d]]
            },
            8211: {
                dir: j,
                HW: [[0.5, m]],
    ...
    a.FONTDATA.FONTS[m][8773][5] = {
        rfix: -222
    };
    MathJax.Hub.Register.LoadHook(a.fontDir + "/TeX/Main-Bold.js", function() {
        a.FONTDATA.FONTS[s][8773][2] -= 106;
        a.FONTDATA.FONTS[s][8773][5] = {
            rfix: -106
        }
    });
    MathJax.Hub.Register.LoadHook(a.fontDir + "/TeX/Typewriter-Regular.js", function() {
        a.FONTDATA.FONTS.MathJax_Typewriter[32][2] += 275;
        a.FONTDATA.FONTS.MathJax_Typewriter[32][5] = {
            rfix: 275
        }
    });
    ...
    a.FONTDATA.familyName = function(t) {
        ...
        var u = v[0].toLowerCase().replace(/(?:igraphic|serif|writer|tur|tor)$/, "") + "-" + v[1].replace(/[^A-Z]/g, "");
        return "MJXc-TeX-" + u
    }
    ;
    (function() {
